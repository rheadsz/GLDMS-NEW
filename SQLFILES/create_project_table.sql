-- Create a new project table with auto-increment ProjectID and EfisProjectId column
DROP TABLE IF EXISTS project_new;

CREATE TABLE project_new (
  ProjectID mediumint unsigned NOT NULL AUTO_INCREMENT,
  EfisProjectId VARCHAR(20) NOT NULL,
  ...
  UNIQUE KEY idx_efis_project_id (EfisProjectId),
