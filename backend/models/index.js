...
const MechanicalAnalysisTest = require("./tests/MechanicalAnalysisTest")(
  sequelize,
);
const SwellPotentialTest = require("./tests/SwellPotentialTest")(sequelize);
const CollapsePotentialTest = require("./tests/CollapsePotentialTest")(
  sequelize,
);
...
const UnconfinedCompressionTest = require("./tests/UnconfinedCompressionTest")(
  sequelize,
);
...
ProjectRequests.hasMany(ProjectStructures, {
  foreignKey: "RequestID",
  as: "structures",
});
ProjectStructures.belongsTo(ProjectRequests, {
  foreignKey: "RequestID",
  as: "request",
});

// Project -> ProjectStructures (1:N)
Project.hasMany(ProjectStructures, {
  foreignKey: "ProjectID",
  as: "structures",
});
ProjectStructures.belongsTo(Project, {
  foreignKey: "ProjectID",
  as: "project",
});

// ProjectStructures -> ProjectBoreholes (1:N)
ProjectStructures.hasMany(ProjectBoreholes, {
  foreignKey: "StructureID",
  as: "boreholes",
});
ProjectBoreholes.belongsTo(ProjectStructures, {
  foreignKey: "StructureID",
  as: "structure",
});

// ProjectBoreholes -> ProjectSamples (1:N)
ProjectBoreholes.hasMany(ProjectSamples, {
  foreignKey: "BoreholeID",
  as: "samples",
});
ProjectSamples.belongsTo(ProjectBoreholes, {
  foreignKey: "BoreholeID",
  as: "borehole",
});
...
ProjectTests.belongsTo(ProjectSamples, {
  foreignKey: "SampleID",
  as: "sample",
});

// ProjectRequests -> ProjectSamples (1:N)
ProjectRequests.hasMany(ProjectSamples, {
  foreignKey: "RequestID",
  as: "samples",
});
ProjectSamples.belongsTo(ProjectRequests, {
  foreignKey: "RequestID",
  as: "request",
});

// ProjectRequests -> ProjectTests (1:N)
ProjectRequests.hasMany(ProjectTests, { foreignKey: "RequestID", as: "tests" });
ProjectTests.belongsTo(ProjectRequests, {
  foreignKey: "RequestID",
  as: "requestRef",
});

// TestType -> ProjectTests (1:N)
TestType.hasMany(ProjectTests, {
...
ProjectRequests.hasMany(ProjectChargingCodes, {
  foreignKey: "RequestID",
  as: "chargingCodes",
});
ProjectChargingCodes.belongsTo(ProjectRequests, {
  foreignKey: "RequestID",
  as: "request",
});

// Specimen -> Test result tables (1:1)
Specimen.hasOne(MoistureContentTest, {
  foreignKey: "SpecimenID",
  as: "moistureContentTest",
});
MoistureContentTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(UnitWeightTest, {
  foreignKey: "SpecimenID",
  as: "unitWeightTest",
});
UnitWeightTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(SpecificGravityTest, {
  foreignKey: "SpecimenID",
  as: "specificGravityTest",
});
SpecificGravityTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(AtterbergLimitsTest, {
  foreignKey: "SpecimenID",
  as: "atterbergLimitsTest",
});
AtterbergLimitsTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(MechanicalAnalysisTest, {
  foreignKey: "SpecimenID",
  as: "mechanicalAnalysisTest",
});
MechanicalAnalysisTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(SwellPotentialTest, {
  foreignKey: "SpecimenID",
  as: "swellPotentialTest",
});
SwellPotentialTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(CollapsePotentialTest, {
  foreignKey: "SpecimenID",
  as: "collapsePotentialTest",
});
CollapsePotentialTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(DirectShearTest, {
  foreignKey: "SpecimenID",
  as: "directShearTest",
});
DirectShearTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(CompactionCurveTest, {
  foreignKey: "SpecimenID",
  as: "compactionCurveTest",
});
CompactionCurveTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(PointLoadTest, {
  foreignKey: "SpecimenID",
  as: "pointLoadTest",
});
PointLoadTest.belongsTo(Specimen, { foreignKey: "SpecimenID", as: "specimen" });

Specimen.hasOne(ExpansionIndexTest, {
  foreignKey: "SpecimenID",
  as: "expansionIndexTest",
});
ExpansionIndexTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(TriaxialCuTest, {
  foreignKey: "SpecimenID",
  as: "triaxialCuTest",
});
TriaxialCuTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(TriaxialUuTest, {
  foreignKey: "SpecimenID",
  as: "triaxialUuTest",
});
TriaxialUuTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(UnconfinedCompressionTest, {
  foreignKey: "SpecimenID",
  as: "unconfinedCompressionTest",
});
UnconfinedCompressionTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(ShrinkageLimitTest, {
  foreignKey: "SpecimenID",
  as: "shrinkageLimitTest",
});
ShrinkageLimitTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});

Specimen.hasOne(SandEquivalentTest, {
  foreignKey: "SpecimenID",
  as: "sandEquivalentTest",
});
SandEquivalentTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});
...
Specimen.hasOne(CorrosionTest, {
  foreignKey: "SpecimenID",
  as: "corrosionTest",
});
CorrosionTest.belongsTo(Specimen, { foreignKey: "SpecimenID", as: "specimen" });

Specimen.hasOne(OrganicContentTest, {
  foreignKey: "SpecimenID",
  as: "organicContentTest",
});
OrganicContentTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});
...
Specimen.hasOne(CationExchangeTest, {
  foreignKey: "SpecimenID",
  as: "cationExchangeTest",
});
CationExchangeTest.belongsTo(Specimen, {
  foreignKey: "SpecimenID",
  as: "specimen",
});
