...
//       const [tables] = await connection.query("SHOW TABLES LIKE 'visiondb'");

//       if (tables.length === 0) {
//         return res
//           .status(404)
//           .json({ message: "visiondb table does not exist" });
//       }

//       // Get the structure of the visiondb table
//       const [columns] = await connection.query("DESCRIBE visiondb");
...
//         return res
//           .status(404)
//           .json({ message: "visiondb table does not exist in the database" });
//       }
